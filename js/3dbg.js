let mContainer;
let mCamera, mRenderer;
let mControls;

let mScene;

let mParticleCount = 60; // <-- change this number!
let mParticleSystem;
...
function initParticleSystem() {
    let prefabGeometry = new THREE.PlaneGeometry(4, 4);
...
THREE.BAS.PrefabBufferGeometry.prototype.bufferDefaults = function() {
    ...
    let positionBuffer = new Float32Array(this.prefabCount * prefabVertexCount * 3);
